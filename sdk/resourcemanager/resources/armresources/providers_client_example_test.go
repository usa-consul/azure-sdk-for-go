...
// Generated from example definition: 2025-04-01/GetProvider.json
func ExampleProvidersClient_Get() {
	...
	res, err := clientFactory.NewProvidersClient().Get(ctx, "Microsoft.TestRP1", nil)
	if err != nil {
	...
	// res = armresources.ProvidersClientGetResponse{
...
// Generated from example definition: 2025-04-01/GetNamedProviderAtTenant.json
func ExampleProvidersClient_GetAtTenantScope() {
	...
	res, err := clientFactory.NewProvidersClient().GetAtTenantScope(ctx, "Microsoft.Storage", &armresources.ProvidersClientGetAtTenantScopeOptions{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armresources.ProvidersClientGetAtTenantScopeResponse{
	// 	Provider: &armresources.Provider{
...
// Generated from example definition: 2025-04-01/GetProviders.json
func ExampleProvidersClient_NewListPager() {
	...
	pager := clientFactory.NewProvidersClient().NewListPager(nil)
	for pager.More() {
		...
		// page = armresources.ProvidersClientListResponse{
		// 	ProviderListResult: armresources.ProviderListResult{
