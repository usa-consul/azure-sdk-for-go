...
// BeginDelete - Deletes a resource group.
//
// When you delete a resource group, all of its resources are also deleted. Deleting a resource group deletes all of its template
...
//
// Resource groups can be updated through a simple PATCH operation to a group address. The format of the request is the same
// as that for creating a resource group. If a field is unspecified, the current value is retained.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2025-04-01
//   - resourceGroupName - The name of the resource group to get. The name is case insensitive.
