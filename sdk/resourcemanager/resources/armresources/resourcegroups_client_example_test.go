...
// Generated from example definition: 2025-04-01/CreateResourceGroup.json
func ExampleResourceGroupsClient_CreateOrUpdate() {
	...
	// res = armresources.ResourceGroupsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2025-04-01/ForceDeleteVMsAndVMSSInResourceGroup.json
func ExampleResourceGroupsClient_BeginDelete_forceDeleteAllTheVirtualMachinesAndVirtualMachineScaleSetsInAResourceGroup() {
	...
	poller, err := clientFactory.NewResourceGroupsClient().BeginDelete(ctx, "my-resource-group", &armresources.ResourceGroupsClientBeginDeleteOptions{
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armresources.ResourceGroupsClientDeleteResponse{
	// }
}

// Generated from example definition: 2025-04-01/ForceDeleteVMsInResourceGroup.json
...
// Generated from example definition: 2025-04-01/ExportResourceGroup.json
func ExampleResourceGroupsClient_BeginExportTemplate_exportAResourceGroup() {
	...
	// 		Error: &armresources.ErrorDetail{
	...
	// 			Details: []*armresources.ErrorDetail{
	// 			},
	// 		},
...
// Generated from example definition: 2025-04-01/ExportResourceGroupWithFiltering.json
